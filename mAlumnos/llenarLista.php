<?php 
	...
	$consulta=mysql_query("SELECT
												...
												alumnos.id_persona,
												alumnos.no_control,
												CONCAT(personas.ap_paterno,' ',personas.ap_materno,' ',personas.nombre) AS NP,
												(SELECT	carreras.nombre FROM carreras WHERE carreras.id_carrera = alumnos.id_carrera) NC,
												alumnos.activo
												FROM
												alumnos
												INNER JOIN personas ON personas.id_persona = alumnos.id_persona
												ORDER BY
												alumnos.id_alumno DESC",$conexion) or die (mysql_error());
